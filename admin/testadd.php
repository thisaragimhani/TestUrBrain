...
echo "<h2 style=text-align:center>ADD TEST</h2>";
...
if(tt.length<1) {
alert("Please Enter Number of Total Question");
...
?>
    ...
    <tr>
      <td height="26"><div align="left"><strong>Enter Total Number of Questions </strong></div></td>
      <td>&nbsp;</td>
