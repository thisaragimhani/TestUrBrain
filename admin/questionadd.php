...
echo "<h2 style=text-align:center>ADD Question</h2>";
...
if(at.length<1) {
alert("Please Enter The correct Answer Number");
...
?>
    ...
    <tr>
      <td height="26"><strong>Enter The number of correct Answer </strong></td>
      <td>&nbsp;</td>
