...
?>
 <table width="100%" align="center">
   <tr>
     <td width="120" rowspan="2" valign="top"><span class="style8"></span></td>
   ...
   <tr>
     <td><form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
			...
			<table class=" table " style="border:1px margin-left:auto;margin-right:auto;" >
		
         <tr>
           <td class="style7" width="20%">LOGIN ID</div></td>
           <td><input class="form-control"type="text" placeholder=" Enter a number as the user Id" name="lid" width="20%"></td>
         </tr>
         <tr>
           <td class="style7">Password</td>
           <td><input class="form-control"type="password" placeholder=" Enter Strong password " name="pass"></td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <td><input class="form-control" name="email" placeholder=" Enter valid email address "  type="text" id="email"></td>
         </tr>
         <tr>
           <td>&nbsp;</td>
